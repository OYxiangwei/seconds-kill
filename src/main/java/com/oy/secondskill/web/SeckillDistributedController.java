...
import com.oy.secondskill.queue.kafka.KafkaSender;
import com.oy.secondskill.queue.redis.RedisSender;
...
public class SeckillDistributedController {
    ...
    @ApiOperation(value="秒杀一(Rediss分布式锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀二(zookeeper分布式锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀三(Redis分布式队列-订阅监听)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀四(Kafka分布式队列)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀五(ActiveMQ分布式队列)",nickname="尚想网")
