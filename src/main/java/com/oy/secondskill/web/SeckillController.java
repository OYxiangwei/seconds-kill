...
import com.oy.secondskill.queue.disruptor.DisruptorUtil;
import com.oy.secondskill.queue.disruptor.SeckillEvent;
import com.oy.secondskill.queue.jvm.SeckillQueue;
...
public class SeckillController {
    ...
    @ApiOperation(value="秒杀一(最low实现)",nickname="尚想网")
    @PostMapping("/start")
    ...
    @ApiOperation(value="秒杀二(程序锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀三(AOP程序锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀四(数据库悲观锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀五(数据库悲观锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀六(数据库乐观锁)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀柒(进程内队列)",nickname="尚想网")
    ...
    @ApiOperation(value="秒杀柒(Disruptor队列)",nickname="尚想网")
