...
import com.oy.secondskill.common.aop.ServiceLock;
...
import com.oy.secondskill.common.aop.ServiceLimit;
import com.oy.secondskill.repository.SeckillRepository;
...
public class SeckillServiceImpl implements ISeckillService {
    ...
    @Override
    public List<SecondsKill> getSeckillList() {
        return seckillRepository.findAll();
    }

    @Override
    public SecondsKill getById(long seckillId) {
    ...
    public Result startSeckilDBOCC(long seckillId, long userId, long number) {
        SecondsKill kill = seckillRepository.findOne(seckillId);
        //if(kill.getNumber()>0){
